            ...
            {editHosting ?
                <>
                    <input
                        ...
                        placeholder={companyData.hosting[0].name_hosting}
                        onChange={handleNameHostingChange}
                        value={editHosting ? nameHosting : companyData.hosting[0].name_hosting}
                    />

                    <textarea
                        name="description_hosting"
                        disabled={!editHosting}
                        placeholder={companyData.hosting[0].description_hosting}
                        onChange={handleDescriptionHostingChange}
                        value={editHosting ? descriptionHosting : companyData.hosting[0].description_hosting}
                    ></textarea>
                    ...
                    <div className="ip">
                        <div className="ipv4">
                            ...
                            <input
                                type="text"
                                disabled={!editHosting}
                                placeholder={companyData.hosting[0].ipv4}
                                onChange={handleIpv4Change}
                                value={editHosting ? ipv4 : companyData.hosting[0].ipv4}
                            />
                        </div>
                        ...
                        <div className="ipv6">
                            ...
                            <input
                                type="text"
                                disabled={!editHosting}
                                placeholder={companyData.hosting[0].ipv6}
                                onChange={handleIpv6Change}
                                value={editHosting ? ipv6 : companyData.hosting[0].ipv6}
                            />
                        </div>
                    </div>
                </>
                :
                <>
                    <input type="text" name="name_hosting" value={companyData.hosting[0].name_hosting} />

                    <textarea name="description_hosting" value={companyData.hosting[0].description_hosting}></textarea>

                    <div className="ip">
                        <div className="ipv4">
                            <h2>IPv4</h2>
                            <input type="text" value={companyData.hosting[0].ipv4} disabled={!companyData.hosting[0].ipv4} />
                        </div>

                        <div className="ipv6">
                            <h2>IPv6</h2>
                            <input type="text" value={companyData.hosting[0].ipv6} disabled={!companyData.hosting[0].ipv6} />
                        </div>
                    </div>
                </>
            }
